...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-12 md:py-12 bg-gray-900 text-white relative overflow-hidden">
      ...
      <h2 className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 text-center text-blue-400 flex items-center justify-center">
        👨🏻‍💼 Work Experience
        <motion.div
        ...
        >
          ...
          >
            <span className="text-xs font-bold uppercase tracking-wider text-blue-100 mr-1">Total:</span>
